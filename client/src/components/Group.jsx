                        ...
                        <div className="flex -mt-2">
                            {
                                selectedUser?.map((e) => {
                                    return (
                                        <button key={e} onClick={() => deleteSelected(e)} className="flex items-center gap-x-1 bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:text-green-400 border border-green-400">
                                            <span>{e.name}</span>
                                            <RxCross2 />
                                        </button>
                                    )
